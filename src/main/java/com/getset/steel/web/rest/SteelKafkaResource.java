...
import com.getset.steel.config.KafkaSseConsumer;
import com.getset.steel.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/steel-kafka")
public class SteelKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SteelKafkaResource.class);
    ...
    public SteelKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
